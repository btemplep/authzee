...
request = {
    ...
    "context_type": "MySpecialContext", # specify the context type
...
# 7.a. Audit - Evaluate grants against the request.
...
batch_request = {
    ...
    "batch": [
        ...
        {} # technically you don't have to override any and the base request will be evaluated
    ]
}
